...
const staticEntries: UrlEntry[] = [
  ...
  { path: '/soumission/', lastmod: defaultLastmod, alternatePaths: ['/en/contact/'] },
  { path: '/amiante/', lastmod: defaultLastmod },
  { path: '/amiante-gatineau/', lastmod: defaultLastmod },
  { path: '/amiante-ottawa/', lastmod: defaultLastmod },
  { path: '/moisissure/', lastmod: defaultLastmod },
  { path: '/moisissure-gatineau/', lastmod: defaultLastmod },
  { path: '/inspection-qualite-air/', lastmod: defaultLastmod },
  { path: '/vermiculite-gatineau/', lastmod: defaultLastmod },
